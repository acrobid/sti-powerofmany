      ...
      <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p class="mt-10 text-center text-sm text-gray-400">
            Not a member? 
            <a href="/components/RegisterModal.vue" class="font-semibold leading-6 text-indigo-400 hover:text-indigo-300">Register now!</a>
          </p>
        </div>
  
        <div class="mt-4 text-center">
          <button @click="closeModal" class="text-gray-400 hover:text-gray-200">Close</button>
        </div>
      </div>
    </div>
  </template>
